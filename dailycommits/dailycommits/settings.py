...
DATABASES = {
    'default': {
        ...
        'NAME': 'dailycommits',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '=$ct7jl62s(29lf5nyg64%lu6l+#y8ac_4pqsaq&amp;-10zfvq!h2'
...
WSGI_APPLICATION = 'dailycommits.wsgi.application'
